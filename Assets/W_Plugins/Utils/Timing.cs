...
namespace Weasel.Utils.Timing
{
    public class Timing : MonoBehaviour
    {
            ...
            if (ActiveInstances[_instanceID] == null)
            {
                ...
                for (; _instanceID <= 0x10; _instanceID++)
                {
                    if (_instanceID == 0x10)
                    {
                        ...
                        throw new System.OverflowException("You are only allowed 15 different contexts for SmartCoroutines to run inside at one time.");
                    }
        ...
        /// <summary>
        /// This will kill all coroutines running on the main SmartCoroutines instance and reset the context.
        ...
        /// <summary>
        /// This will kill all coroutines running on the current SmartCoroutines instance and reset the context.
        /// NOTE: If you call this function from within a running coroutine then you MUST end the current
        /// coroutine. If the running coroutine has more work to do you may run a new "part 2" coroutine 
        /// function to complete the task before ending the current one.
        /// </summary>
        ...
        /// <summary>
        /// This will pause all coroutines running on the current SmartCoroutines instance until ResumeCoroutines is called.
        /// </summary>
        ...
        /// <summary>
        /// This will pause all coroutines running on this SmartCoroutines instance until ResumeCoroutinesOnInstance is called.
        /// </summary>
        /// <returns>The number of coroutines that were paused.</returns>
        ...
        /// <summary>
        /// This will pause any matching coroutines running on this SmartCoroutines instance until ResumeCoroutinesOnInstance is called.
        /// </summary>
        /// <param name="handle">The handle of the coroutine to pause.</param>
        /// <returns>The number of coroutines that were paused (0 or 1).</returns>
        ...
        /// <summary>
        /// This will pause any matching coroutines running on the current SmartCoroutines instance until ResumeCoroutines is called.
        /// </summary>
        ...
        /// <summary>
        /// This resumes all coroutines on the current SmartCoroutines instance if they are currently paused, otherwise it has
        /// no effect.
        /// </summary>
        ...
        /// <summary>
        /// This resumes all coroutines on this SmartCoroutines instance if they are currently paused, otherwise it has no effect.
        /// </summary>
        /// <returns>The number of coroutines that were resumed.</returns>
        ...
        /// <summary>
        /// This will resume any matching coroutines running on this SmartCoroutines instance.
        /// </summary>
        /// <param name="handle">The handle of the coroutine to resume.</param>
        /// <returns>The number of coroutines that were resumed (0 or 1).</returns>
        ...
        /// <summary>
        /// This resumes any matching coroutines on the current SmartCoroutines instance if they are currently paused, otherwise it has
        /// no effect.
        /// </summary>
        ...
        /// <summary>
        /// This resumes any matching coroutines on this SmartCoroutines instance if they are currently paused, otherwise it has no effect.
        /// </summary>
        /// <param name="tag">Any coroutines previously paused with a matching tag will be resumend.</param>
        /// <returns>The number of coroutines that were resumed.</returns>
        ...
        /// <summary>
        /// Retrieves the SmartCoroutines manager that corresponds to the supplied instance id.
        /// </summary>
        ...
        public static float WaitUntilDone(CoroutineHandle otherCoroutine, bool warnOnIssue)
        {
            ...
            if (inst != null && inst._handleToIndex.ContainsKey(otherCoroutine))
            {
                ...
                {
                    Assert.IsFalse(warnOnIssue, "The two coroutines are not running on the same SmartCoroutines instance.");
                    return WaitForOneFrame;
                }
        ...
        [System.Obsolete("Shouldn't be run on SmartCoroutine Objects.", true)]
    ...
    /// <summary>
    /// A handle for a SmartCoroutines coroutine.
    /// </summary>
